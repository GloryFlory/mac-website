          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <Reveal delay={0.2}>
              <div className="bg-white rounded-2xl shadow-xl border-2 border-brand-sun p-8 relative overflow-hidden flex flex-col h-full">
                ...
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-2 px-4 py-2 bg-brand-sun text-zinc-900 rounded-full text-xs font-bold shadow-lg">
