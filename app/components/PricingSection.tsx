...
const PricingSection: FC = () => {
  return (
    <section className="py-20 sm:py-24 lg:py-32 px-6 bg-gradient-to-b from-brand-sand/20 to-white dark:from-zinc-950 dark:to-zinc-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
          {pricingTiers.map((tier, index) => (
            <Reveal key={tier.id} delay={index * 0.1}>
              <div
                className={`relative bg-white dark:bg-zinc-900 rounded-2xl p-8 transition-all duration-300 ${
                  tier.highlighted
                    ? 'border-2 border-brand-sun shadow-xl scale-105'
                    : 'border border-neutral-200/20 dark:border-zinc-800 hover:shadow-lg'
                }`}
              >
                {/* Highlighted Badge */}
                {tier.highlighted && (
                ...
                <div className="text-center mb-6">
                  <h3 className="font-serif text-2xl font-bold text-brand-sea dark:text-white mb-2">
                    {tier.name}
                  </h3>
                ...
                {tier.available ? (
                  ...
                  <div className="w-full px-8 py-3 text-base text-center font-semibold rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-400 dark:text-zinc-600 cursor-not-allowed">
                    Sold Out
                  </div>
                )}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Reveal delay={0.3}>
            <div className="bg-white dark:bg-zinc-900 border border-neutral-200/20 dark:border-zinc-800 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-sea dark:text-white">
                  What's Included
                </h3>
              </div>
          ...
          <Reveal delay={0.35}>
            <div className="bg-brand-sand/10 dark:bg-zinc-900 border border-neutral-200/20 dark:border-zinc-800 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                  <svg className="w-5 h-5 text-zinc-600 dark:text-zinc-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul className="space-y-3">
                {notIncluded.map((item, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-zinc-400 dark:text-zinc-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                    </svg>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-500 mt-4 pt-4 border-t border-neutral-200/20 dark:border-zinc-800">
