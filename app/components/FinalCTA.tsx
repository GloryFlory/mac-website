...
const FinalCTA: FC = () => {
  return (
    <section className="relative py-20 sm:py-24 lg:py-32 px-6 bg-gradient-to-br from-brand-sea to-[#0D5A8A] overflow-hidden">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center items-center text-sm sm:text-base">
                ...
                >
                  ...
                  <span className="hidden sm:inline">mediterraneanacroconvention@gmail.com</span>
                  <span className="sm:hidden">Email Us</span>
                </a>

                {/* WhatsApp */}
                <a
                  href="https://wa.me/35699701254"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-brand-sun transition-colors duration-200"
                >
                ...
                >
                  ...
                  <span>@mediterranean_acro_convention</span>
                </a>
              </div>
            </div>
          </div>
